...
//!
//! A self-contained Rust port of the TypeScript CLI in `../src` (entry point:
//! `../src/cli.ts`). Module names mirror the TS files they port.
...
mod tests {
    ...
    fn version_matches_package_json_when_present() {
        ...
        assert_eq!(
            ...
            super::VERSION,
            "bump rust/Cargo.toml when package.json changes"
        );
    }
}
